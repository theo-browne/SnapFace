    ...
    render(){
        ...
        return(
            <div className="comment-index">
                <ul>
                    {this.props.comments.map(comment => <CommentIndexItem key={comment.id} updateReaction={this.props.updateReaction} deleteReaction={this.props.deleteReaction} createReaction={this.props.createReaction}  setComment={this.props.setComment} deleteComment={this.props.deleteComment} updateComment={this.props.updateComment} currentUser={this.props.currentUser} comment={comment} /> )}
                </ul>
                {button}
                {hide}
            </div>
